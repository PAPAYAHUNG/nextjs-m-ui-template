      ...
      <Box sx={{ display: "flex", flexDirection: "column", height: "100%" }}>
        ...
        >
          ...
          <IconButton
            ...
            sx={{ ml: collapsed ? 0 : 1, color: "#7C8FAC" }}
          >
              ...
              <List disablePadding>
                {section.items.map((item) => {
                  ...
                  return (
                    <Tooltip
                      key={item.label}
                      title={collapsed ? item.label : item.caption || ""}
                      placement="right"
                      arrow
                      disableHoverListener={!collapsed && !item.caption}
                    >
                      <span>
                        <ListItem
                          disablePadding
